...
def get_moreDA_augmentation_train(dataloader_train, patch_size, params=default_3D_augmentation_params,
                                  border_val_seg=-1,
...
def get_moreDA_augmentation_val(dataloader_val, params=default_3D_augmentation_params,
...
def get_moreDA_augmentation_train_pseudo(dataloader_train, params=default_3D_augmentation_params,
                                  seeds_train=None, deep_supervision_scales=None,
                                  soft_ds=False,
                                  classes=None, pin_memory=True, regions=None,
                                  use_nondetMultiThreadedAugmenter: bool = False):
    assert params.get('mirror') is None, "old version of params, use new keyword do_mirror"
