...
class ExperimentPlanner3D_v21_4GB(ExperimentPlanner3D_v21):
    """
    Same as ExperimentPlanner3D_v21, but designed to fill 4GB in fp16
    """
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_v21_4GB, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_v2.1_4GB"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansv2.1_4GB_plans_3D.pkl")
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        # typical ExperimentPlanner3D_v21 configurations use ~8.5GB, but here we allow for only 4GB
        # to be used
        ref = Generic_UNet.use_this_for_batch_size_computation_3D * 4/9
