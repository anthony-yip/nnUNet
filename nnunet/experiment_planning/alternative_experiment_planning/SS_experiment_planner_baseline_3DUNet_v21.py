...
class SS_ExperimentPlanner3D_v21(ExperimentPlanner3D_v21):
    ...
    """
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder, vram_size=36, ignore_unlabeled=False):
        ...
        self.list_of_cropped_npz_files_labeled = subfiles(self.folder_with_cropped_data_labeled, True, None, ".npz", True)
        ...
        self.list_of_cropped_npz_files_validation = subfiles(self.folder_with_cropped_data_validation, True, None, ".npz", True)
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        ref = Generic_UNet.use_this_for_batch_size_computation_3D * 0.5 * self.vram_size / 8  # 8 instead of 8.5 because YOLO
        # this is because I doubled the batch size
    ...
    def run_preprocessing(self, num_threads):
        ...
        for subfolder in subfolders:
            preprocessor.run(target_spacings, join(self.folder_with_cropped_data, subfolder),
                             ...
                             self.plans['data_identifier'], all_classes, num_threads)
